...
public class c {
    ...
    private void d() {
        ...
        if (cVar != null) {
            if (i.m94a(cVar.getString("UTDID2"))) {
            ...
            boolean z = false;
            boolean z2 = true;
            if (!i.m94a(this.b.getString("DID"))) {
                this.b.remove("DID");
                z = true;
            }
            if (!i.m94a(this.b.getString("EI"))) {
                this.b.remove("EI");
                z = true;
            }
            if (i.m94a(this.b.getString("SI"))) {
                z2 = z;
            } else {
                this.b.remove("SI");
            }
    ...
    private String g() {
        ...
        if (cVar != null) {
            ...
            if (!i.m94a(string) && this.f197a.a(string) != null) {
                return string;
            }
            return null;
        }
