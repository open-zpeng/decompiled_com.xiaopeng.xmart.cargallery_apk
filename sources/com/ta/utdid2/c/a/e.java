...
class e {
    ...
    public static final void a(Map map, String str, XmlSerializer xmlSerializer) throws XmlPullParserException, IOException {
        ...
        if (str != null) {
            xmlSerializer.attribute(null, SerializableCookie.NAME, str);
        }
    ...
    public static final HashMap m100a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public static final int[] m101a(XmlPullParser xmlPullParser, String str, String[] strArr) throws XmlPullParserException, IOException {
        try {
    ...
    private static final Object b(XmlPullParser xmlPullParser, String[] strArr) throws XmlPullParserException, IOException {
        int next;
        Object obj = null;
        String attributeValue = xmlPullParser.getAttributeValue(null, SerializableCookie.NAME);
        ...
        if (!name.equals("null")) {
            if (name.equals(TypedValues.Custom.S_STRING)) {
                ...
                xmlPullParser.next();
                int[] m101a = m101a(xmlPullParser, "int-array", strArr);
                strArr[0] = attributeValue;
                return m101a;
            } else if (name.equals("map")) {
                xmlPullParser.next();
                HashMap m100a = m100a(xmlPullParser, "map", strArr);
                strArr[0] = attributeValue;
                return m100a;
