        ...
        if (lastInterval < currentInterval || force) {
            ...
            ThreadUtils.post(2, new Runnable() { // from class: com.xiaopeng.datalog.counter.CounterImpl.1
                ...
                public void run() {
                    ...
                    IMoleEventBuilder event = dataLogService.buildMoleEvent().setPageId("P00012").setButtonId(BIConfig.ButtionID.GALLERY_OPERATION_PANORAMA).setEvent(CounterImpl.this.mName);
