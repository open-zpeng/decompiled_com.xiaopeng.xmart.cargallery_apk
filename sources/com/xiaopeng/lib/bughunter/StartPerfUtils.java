...
public class StartPerfUtils {
    ...
    private static long appCreateBeginStamp;
    private static long appCreateEndStamp;
    private static long appCreateTime;
    private static long appFirstFrameTime;
    private static long appMainActTime;
    private static long firstFrameEndStamp;
    ...
    private static void sendPerformData(Context context) {
        ...
        try {
            dataLogService = (IDataLog) Module.get(DataLogModuleEntry.class).get(IDataLog.class);
        } catch (Exception e) {
            e.printStackTrace();
