...
public class RemoteLogHelp {
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() { // from class: com.xiaopeng.lib.bughunter.RemoteLogHelp.1
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            RemoteLogHelp.this.mRemoteLogService = IRemoteLogInterface.Stub.asInterface(service);
            ...
            try {
                ...
                LogUtils.w(RemoteLogHelp.TAG, "RemoteException occurs when reLink to Service, exception:", mE);
            }
        }
    ...
    public void binderService(Context context) {
        ...
        intent.setPackage(DATA_COLLECTOR_PACKAGE_NAME);
