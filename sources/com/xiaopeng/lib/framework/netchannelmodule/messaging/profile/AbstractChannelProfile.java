...
public abstract class AbstractChannelProfile {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    /* JADX WARN: Removed duplicated region for block: B:8:0x0021 A[Catch: UnknownHostException -> 0x0084, TryCatch #0 {UnknownHostException -> 0x0084, blocks: (B:3:0x0005, B:5:0x0017, B:6:0x001b, B:8:0x0021, B:10:0x002d, B:14:0x003f, B:16:0x0065, B:12:0x0033), top: B:23:0x0005 }] */
    /*
    ...
    */
    public static java.lang.String resolveWithDns(java.lang.String r7) {
        /*
            ...
            com.xiaopeng.lib.framework.netchannelmodule.http.xmart.TimeoutDns r2 = com.xiaopeng.lib.framework.netchannelmodule.http.xmart.TimeoutDns.getInstance()     // Catch: java.net.UnknownHostException -> L84
            java.lang.String r3 = r1.getHost()     // Catch: java.net.UnknownHostException -> L84
            java.util.List r2 = r2.lookupAsync(r3)     // Catch: java.net.UnknownHostException -> L84
            boolean r3 = r2.isEmpty()     // Catch: java.net.UnknownHostException -> L84
            if (r3 != 0) goto L83
            java.util.Iterator r3 = r2.iterator()     // Catch: java.net.UnknownHostException -> L84
        L1b:
            boolean r4 = r3.hasNext()     // Catch: java.net.UnknownHostException -> L84
            if (r4 == 0) goto L83
            java.lang.Object r4 = r3.next()     // Catch: java.net.UnknownHostException -> L84
            java.net.InetAddress r4 = (java.net.InetAddress) r4     // Catch: java.net.UnknownHostException -> L84
            boolean r5 = r4.isSiteLocalAddress()     // Catch: java.net.UnknownHostException -> L84
            if (r5 != 0) goto L33
            boolean r5 = r4.isLoopbackAddress()     // Catch: java.net.UnknownHostException -> L84
            if (r5 == 0) goto L3f
        L33:
            java.lang.String r5 = r4.getHostAddress()     // Catch: java.net.UnknownHostException -> L84
            java.lang.String r6 = "10."
            boolean r5 = r5.startsWith(r6)     // Catch: java.net.UnknownHostException -> L84
            if (r5 == 0) goto L82
        L3f:
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch: java.net.UnknownHostException -> L84
            r3.<init>()     // Catch: java.net.UnknownHostException -> L84
            java.lang.String r5 = r1.getScheme()     // Catch: java.net.UnknownHostException -> L84
            java.lang.StringBuilder r3 = r3.append(r5)     // Catch: java.net.UnknownHostException -> L84
            java.lang.String r5 = "://"
            java.lang.StringBuilder r3 = r3.append(r5)     // Catch: java.net.UnknownHostException -> L84
            java.lang.String r5 = r4.getHostAddress()     // Catch: java.net.UnknownHostException -> L84
            java.lang.StringBuilder r3 = r3.append(r5)     // Catch: java.net.UnknownHostException -> L84
            java.lang.String r3 = r3.toString()     // Catch: java.net.UnknownHostException -> L84
            r0 = r3
            int r3 = r1.getPort()     // Catch: java.net.UnknownHostException -> L84
            if (r3 <= 0) goto L83
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch: java.net.UnknownHostException -> L84
            r3.<init>()     // Catch: java.net.UnknownHostException -> L84
            java.lang.StringBuilder r3 = r3.append(r0)     // Catch: java.net.UnknownHostException -> L84
            java.lang.String r5 = ":"
            java.lang.StringBuilder r3 = r3.append(r5)     // Catch: java.net.UnknownHostException -> L84
            int r5 = r1.getPort()     // Catch: java.net.UnknownHostException -> L84
            java.lang.StringBuilder r3 = r3.append(r5)     // Catch: java.net.UnknownHostException -> L84
            java.lang.String r3 = r3.toString()     // Catch: java.net.UnknownHostException -> L84
            r0 = r3
            goto L83
