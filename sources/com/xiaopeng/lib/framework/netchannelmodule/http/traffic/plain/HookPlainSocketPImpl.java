...
public class HookPlainSocketPImpl extends SocketImpl {
    ...
    protected void connect(String host, int port) throws IOException {
        ...
        this.mDomain = host + ":" + port;
        Method method = getMethod("connect0", mSuperClass, MqttServiceConstants.CONNECT_ACTION, String.class, Integer.TYPE);
    ...
    protected void connect(InetAddress address, int port) throws IOException {
        ...
        Method method = getMethod("connect1", mSuperClass, MqttServiceConstants.CONNECT_ACTION, InetAddress.class, Integer.TYPE);
        invoke(method, true, this.mDelegate, address, Integer.valueOf(port));
        this.mCounter.increaseRequest(this.mDomain, 0L);
    }
    ...
    protected void connect(SocketAddress remoteAddr, int timeout) throws IOException {
        ...
        Method method = getMethod("connect2", mSuperClass, MqttServiceConstants.CONNECT_ACTION, SocketAddress.class, Integer.TYPE);
