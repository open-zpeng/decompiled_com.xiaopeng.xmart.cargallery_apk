...
public class HookPlainSocketKitKatImpl extends SocketImpl implements SocketOptions {
    ...
    public HookPlainSocketKitKatImpl(SocketImpl socketImpl) {
        ...
        if (socketImpl != null) {
            try {
                ...
                this.mHookConnectHostPort = clazz.getDeclaredMethod(MqttServiceConstants.CONNECT_ACTION, String.class, Integer.TYPE);
                this.mHookConnectInetAddrPort = clazz.getDeclaredMethod(MqttServiceConstants.CONNECT_ACTION, InetAddress.class, Integer.TYPE);
                this.mHookConnectSocketAddrPort = clazz.getDeclaredMethod(MqttServiceConstants.CONNECT_ACTION, SocketAddress.class, Integer.TYPE);
    ...
    protected void connect(InetAddress address, int port) throws IOException {
        ...
        if (address != null) {
            ...
            this.mDomain = address.getHostName() + ":" + port;
        }
        SocketImpl socketImpl = this.mSocketImpl;
