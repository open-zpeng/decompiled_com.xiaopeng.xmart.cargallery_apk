...
public class TrafficStatsEntry {
    ...
    static {
        ...
        sEntry = hashMap;
        hashMap.clear();
        hashMap.put("com.xiaopeng.ota", new Entry(100000, TAG_APP_OTA));
        hashMap.put("com.xiaopeng.oobe", new Entry(100001, TAG_APP_OOBE));
        hashMap.put("com.xiaopeng.appengine", new Entry(100002, TAG_APP_ENGINE));
        hashMap.put("com.xiaopeng.autopilot", new Entry(100003, TAG_APP_AUTOPILOT));
        hashMap.put("com.xiaopeng.devtools", new Entry(100004, TAG_APP_DEV_TOOLS));
        hashMap.put("com.xiaopeng.xuiservice", new Entry(100005, TAG_APP_XUI_SERVICE));
        hashMap.put("com.xiaopeng.data.collector", new Entry(100006, TAG_APP_DATA_COLLECTOR));
        hashMap.put("com.xiaopeng.data.uploader", new Entry(100007, TAG_APP_DATA_UPLOADER));
        hashMap.put("com.xiaopeng.btphone", new Entry(100008, TAG_APP_BLUETOOTH_PHONE));
        hashMap.put("com.xiaopeng.aiavatarservice", new Entry(100009, TAG_APP_AVATAR_SERVICE));
        hashMap.put("com.xiaopeng.device.communication", new Entry(100010, TAG_APP_DEVICE_COMMUNICATION));
        hashMap.put("com.xiaopeng.xmart.camera", new Entry(100011, TAG_APP_CAR_CAMERA));
        hashMap.put("com.xiaopeng.xmart.cargallery", new Entry(100012, TAG_APP_CAR_GALLERY));
        ...
        hashMap.put("com.xiaopeng.bughunter", new Entry(100020, TAG_APP_BUG_HUNTER));
        hashMap.put("com.xiaopeng.autoshow", new Entry(100021, TAG_APP_AUTO_SHOW));
        hashMap.put("com.xiaopeng.factory", new Entry(100022, TAG_APP_FACTORY));
        hashMap.put("com.xiaopeng.cardiagnosis", new Entry(100023, TAG_APP_CAR_DIAGNOSIS));
