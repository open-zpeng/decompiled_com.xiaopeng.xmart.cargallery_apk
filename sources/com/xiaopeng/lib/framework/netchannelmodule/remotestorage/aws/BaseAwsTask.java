...
public abstract class BaseAwsTask implements Runnable {
    ...
    public String generateObjectKey(String moduleName) {
        ...
        return this.mBucket + MqttTopic.TOPIC_LEVEL_SEPARATOR + moduleName + MqttTopic.TOPIC_LEVEL_SEPARATOR + BuildInfoUtils.getSystemVersion() + MqttTopic.TOPIC_LEVEL_SEPARATOR + DateUtils.formatDate7(timeStamp) + MqttTopic.TOPIC_LEVEL_SEPARATOR + SystemPropertyUtil.getVehicleId() + MqttTopic.TOPIC_LEVEL_SEPARATOR + timeStamp + ".zip";
    }
