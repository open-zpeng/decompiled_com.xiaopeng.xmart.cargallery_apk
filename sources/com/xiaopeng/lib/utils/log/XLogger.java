...
public class XLogger implements LogUtils.Logger, Handler.Callback {
    ...
    public void logByLevel(int type, String msg, String TAG2, String fileName) {
        ...
        switch (type) {
            case 2:
                this.mXlog.logV(TAG2, fileName, null, 0, this.mPid, tid, this.mMainThreadId, msg);
                return;
            case 3:
                this.mXlog.logD(TAG2, fileName, null, 0, this.mPid, tid, this.mMainThreadId, msg);
                return;
            case 4:
                this.mXlog.logI(TAG2, fileName, null, 0, this.mPid, tid, this.mMainThreadId, msg);
                return;
            case 5:
                this.mXlog.logW(TAG2, fileName, null, 0, this.mPid, tid, this.mMainThreadId, msg);
                return;
            case 6:
                this.mXlog.logE(TAG2, fileName, null, 0, this.mPid, tid, this.mMainThreadId, msg);
                return;
            default:
                return;
        }
