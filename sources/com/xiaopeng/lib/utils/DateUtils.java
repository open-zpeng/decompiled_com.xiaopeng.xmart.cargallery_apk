...
public class DateUtils {
    ...
    public static String getYearMonthAndDayFormatString(Locale locale, long data) {
        char c;
        ...
        switch (c) {
            case 0:
            case 1:
                return sSimpleFormat12.format(Long.valueOf(data));
            default:
                return sSimpleFormat11.format(Long.valueOf(data));
        }
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    public static String getMonthAndDayFormatString(Locale locale, long data) {
        char c;
        String country = locale.getCountry();
        switch (country.hashCode()) {
            case 2099:
        ...
        switch (c) {
            case 0:
            case 1:
                return sSimpleFormat14.format(Long.valueOf(data));
            default:
                return sSimpleFormat13.format(Long.valueOf(data));
        }
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    public static String getWeekAndMonthAndDayFormatString(Locale locale, long data) {
        char c;
        String country = locale.getCountry();
        switch (country.hashCode()) {
            case 2099:
        ...
        switch (c) {
            case 0:
            case 1:
                return sSimpleFormat16.format(Long.valueOf(data));
            default:
                return sSimpleFormat15.format(Long.valueOf(data));
        }
    }
}
