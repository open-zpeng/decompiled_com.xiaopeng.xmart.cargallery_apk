...
public class XViewLocationUtils {
    ...
    public static void scrollByLocation(View view, OnCorrectionLocationListener listener) {
    ...
    public static void scrollByLocation(final ViewGroup parentView, final View view, final OnCorrectionLocationListener listener) {
