...
public class XSwitch extends XCompoundButton implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void runAnimator(int dstValue) {
        ValueAnimator ofInt = ValueAnimator.ofInt(this.mCurrentAnimValue, dstValue);
        this.mValueAnimator = ofInt;
        ofInt.setDuration(Math.abs(dstValue - this.mCurrentAnimValue));
    ...
    private void updateVerticalFraction() {
        ...
        if (i <= 200) {
            ...
            this.mVerticalLightColor = changeColorAlpha(alphaPercent, i2);
        } else if (i <= 500) {
            ...
            this.mVerticalLightColor = changeColorAlpha(alphaPercent2, i3);
        }
    }
