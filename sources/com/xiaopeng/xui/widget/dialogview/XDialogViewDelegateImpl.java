...
public class XDialogViewDelegateImpl extends XDialogViewDelegate {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public XDialogViewDelegateImpl(XDialogView xDialogView, Context context, int style) {
            ...
            public void onClick(View v) {
                ...
                if (id == R.id.x_dialog_button1) {
                    if (XDialogViewDelegateImpl.this.mPositiveListener != null) {
                        XDialogViewDelegateImpl.this.logs("onClick  positiveIntercept " + positiveInterceptDismiss + " , mPositiveListener " + XDialogViewDelegateImpl.this.mPositiveListener);
                    ...
                    if (XDialogViewDelegateImpl.this.mNegativeListener != null) {
                        XDialogViewDelegateImpl.this.logs("onClick negativeIntercept " + negativeInterceptDismiss + " , mNegativeListener " + XDialogViewDelegateImpl.this.mNegativeListener);
    ...
    private void init() {
        ...
        xDialogContentView.setMaxHeight(maxHeight);
    ...
    @Override // com.xiaopeng.xui.widget.dialogview.XDialogViewDelegate
    public void setCustomView(View view, boolean useScroll) {
        this.mContentView.removeAllViews();
        if (useScroll) {
    ...
    @Override // com.xiaopeng.xui.widget.dialogview.XDialogViewDelegate
    public void setCustomView(int resId, boolean useScroll) {
    ...
    public void setSingleChoiceItems(CharSequence[] items, int checkedItem, XDialogViewInterface.OnClickListener listener) {
        ...
        this.mXDialogList.setSingleChoiceItems(items, checkedItem, new AdapterView.OnItemClickListener() { // from class: com.xiaopeng.xui.widget.dialogview.-$$Lambda$XDialogViewDelegateImpl$K1C6D2DkaKw-Kn0emAtivdaUpts
    ...
    @Override // com.xiaopeng.xui.widget.dialogview.XDialogViewDelegate
    public void setPositiveButton(int text, XDialogViewInterface.OnClickListener listener) {
        setPositiveButton(text);
        setPositiveButtonListener(listener);
    }

    @Override // com.xiaopeng.xui.widget.dialogview.XDialogViewDelegate
    public void setPositiveButton(CharSequence text, XDialogViewInterface.OnClickListener listener) {
        setPositiveButton(text);
        setPositiveButtonListener(listener);
    }
    ...
    @Override // com.xiaopeng.xui.widget.dialogview.XDialogViewDelegate
    public void setNegativeButton(int text, XDialogViewInterface.OnClickListener listener) {
        setNegativeButton(text);
        setNegativeButtonListener(listener);
    }

    @Override // com.xiaopeng.xui.widget.dialogview.XDialogViewDelegate
    public void setNegativeButton(CharSequence text, XDialogViewInterface.OnClickListener listener) {
        setNegativeButton(text);
        setNegativeButtonListener(listener);
    }
    ...
    public void startPositiveButtonCountDown(int delayDismiss) {
        ...
        if (this.mPositiveButton.getVisibility() == 0 && delayDismiss > 0) {
            ...
            xCountDown2.start(this.mPositiveButton.getText().toString(), delayDismiss);
        }
    }
    ...
    public void startNegativeButtonCountDown(int delayDismiss) {
        ...
        if (this.mNegativeButton.getVisibility() == 0 && delayDismiss > 0) {
            ...
            this.mCountDownHandler = xCountDown2;
            xCountDown2.start(this.mNegativeButton.getText().toString(), delayDismiss);
        }
    }
    ...
    public class XDialogContentView extends XLinearLayout {
        ...
        public XDialogContentView(Context context, AttributeSet attrs) {
            super(context, attrs);
            setOrientation(1);
        ...
        public void onWindowFocusChanged(boolean hasWindowFocus) {
            ...
            XDialogViewDelegateImpl.this.logs("hasWindowFocus " + hasWindowFocus);
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int wSpec = View.MeasureSpec.makeMeasureSpec(this.mW, BasicMeasure.EXACTLY);
            int i = this.mH;
            if (i <= 0) {
