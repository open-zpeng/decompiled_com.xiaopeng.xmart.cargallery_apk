...
public abstract class XDialogViewDelegate {
    ...
    public static XDialogViewDelegate create(XDialogView xDialogView, Context context, int style) {
        return new XDialogViewDelegateImpl(xDialogView, context, style);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public XDialogViewDelegate(XDialogView xDialogView, Context context, int style) {
