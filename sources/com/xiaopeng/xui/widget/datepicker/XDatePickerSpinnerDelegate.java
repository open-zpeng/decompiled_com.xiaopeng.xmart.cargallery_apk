...
public class XDatePickerSpinnerDelegate extends XDatePicker.AbstractXDatePickerDelegate {
    ...
    public XDatePickerSpinnerDelegate(XDatePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        XNumberPicker.OnValueChangeListener onChangeListener = new XNumberPicker.OnValueChangeListener() { // from class: com.xiaopeng.xui.widget.datepicker.-$$Lambda$XDatePickerSpinnerDelegate$4vNSUARTO8kyMe3fYUDgNOLfJ7k
    ...
    private void updateSpinners() {
        ...
        String[] yearDisplayValues = new String[NaviPreferenceBean.PATH_PREF_AVOID_TOLL];
