...
public class XTabsBar extends XRelativeLayout implements IVuiElementListener {
    ...
    public XTabsBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XTabsBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        xImageButton.setVisibility(tabsBarBtnVisibility);
        ...
        XTabLayout xTabLayout = new XTabLayout(context, attrs, defStyleAttr2, defStyleRes);
        this.mTabLayout = xTabLayout;
        int count = xTabLayout.getTabCount();
