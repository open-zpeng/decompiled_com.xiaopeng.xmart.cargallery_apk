...
public class XNumberPicker extends XLinearLayout {
    ...
    public XNumberPicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        int dimensionPixelSize3 = attributesArray.getDimensionPixelSize(R.styleable.XNumberPicker_np_internalMinHeight, -1);
        this.mMinHeight = dimensionPixelSize3;
        int dimensionPixelSize4 = attributesArray.getDimensionPixelSize(R.styleable.XNumberPicker_np_internalMaxHeight, -1);
        this.mMaxHeight = dimensionPixelSize4;
        if (dimensionPixelSize3 == -1 || dimensionPixelSize4 == -1 || dimensionPixelSize3 <= dimensionPixelSize4) {
            int dimensionPixelSize5 = attributesArray.getDimensionPixelSize(R.styleable.XNumberPicker_np_internalMinWidth, -1);
            this.mMinWidth = dimensionPixelSize5;
            int dimensionPixelSize6 = attributesArray.getDimensionPixelSize(R.styleable.XNumberPicker_np_internalMaxWidth, -1);
            this.mMaxWidth = dimensionPixelSize6;
            ...
            ColorStateList colorStateList = attributesArray.getColorStateList(R.styleable.XNumberPicker_android_textColor);
    ...
    public void scrollBy(int x, int y) {
        ...
        if (!z && y > 0 && selectorIndices[2] <= this.mMinValue) {
            this.mCurrentScrollOffset = this.mInitialScrollOffset;
        } else if (!z && y < 0 && selectorIndices[2] >= this.mMaxValue) {
            this.mCurrentScrollOffset = this.mInitialScrollOffset;
        } else {
    ...
    private void initializeSelectorWheel() {
        ...
        this.mSelectorElementHeight = i2 + i;
        this.mSelectedSelectorElementHeight = this.mSelectedTextSize + i;
        int i3 = i + (i2 / 2);
