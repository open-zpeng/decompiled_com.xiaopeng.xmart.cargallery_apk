...
public abstract class Prompt {
    ...
    public void show(CharSequence text, int actionIcon, String actionId) {
        show(text, actionIcon, actionId, 1);
    }

    public void show(CharSequence text, int actionIcon, String actionId, int duration) {
        show(new XPromptMessage(duration, text, actionIcon, actionId));
    }

    public void show(CharSequence text, CharSequence actionButton, String actionId) {
        show(text, actionButton, actionId, 1);
    }

    public void show(CharSequence text, CharSequence actionButton, String actionId, int duration) {
        show(new XPromptMessage(duration, text, actionButton, actionId));
    }

    public void show(XPromptMessage message) {
        addMessage(message);
        enqueuePrompt();
    }
