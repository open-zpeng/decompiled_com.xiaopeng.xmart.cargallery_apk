...
public class XTitleBar extends XLinearLayout implements View.OnClickListener, IVuiElementListener {
    ...
    public XTitleBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        switch (actionMode) {
            ...
            case 2:
                ...
                break;
            case 4:
                int actionCustom = a.getResourceId(R.styleable.XTitleBar_title_action_1, -1);
                if (actionCustom != -1) {
    ...
    private void addActionWithIcon(int... action) {
        if (action != null) {
    ...
    private void addActionWithButton(CharSequence... action) {
        for (int i = 0; i < action.length; i++) {
    ...
    public void setActionWithIcon(int action1, int action2) {
        this.mRightContainer.removeAllViews();
