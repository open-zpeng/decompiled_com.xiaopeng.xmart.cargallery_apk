...
public class XCircularProgressBgDrawable extends Drawable {
    ...
    private void updateAttr(Resources resources, AttributeSet attrs, Resources.Theme theme) {
        ...
        int color = ta.getColor(R.styleable.XCircularProgressBgDrawable_progress_backgroundColor, resources.getColor(R.color.x_circular_progress_circle_bg_color, theme));
