...
public class XLoadingDrawable extends Drawable {
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws IOException, XmlPullParserException {
        ...
        int resourceId = ta.getResourceId(R.styleable.XLoadingDrawable_loading_color, R.color.x_theme_text_01);
        this.mColorId = resourceId;
        this.mColor = r.getColor(resourceId, theme);
    ...
    private void makeAnimations() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            this.mAnimations[index].addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.xiaopeng.xui.drawable.-$$Lambda$XLoadingDrawable$7JxianTfjXpK-B_79kQgsAEg0T8
