...
public class VuiFloatingLayer implements IVuiFloatingLayer {
    ...
    public void showFloatingLayer(View targetView, final int type, int centerOffsetX, int centerOffsetY) {
        ...
        view.postDelayed(new Runnable() { // from class: com.xiaopeng.xui.vui.floatinglayer.-$$Lambda$VuiFloatingLayer$Gk465cVpu0Pjw9tKwY1PCgn7Low
            @Override // java.lang.Runnable
