...
public class XOsd {
    ...
    public static void showOsd(CharSequence title, Icon icon, int progress, int progressMin, int progressMax) {
        showOsd(title, null, null, icon, null, progress, progressMin, progressMax);
    }

    public static void showOsd(CharSequence title, Icon icon, CharSequence content) {
        showOsd(title, null, null, icon, content, 0, 0, 0);
    }

    public static void showOsd(CharSequence title, Icon left, Icon right, Icon icon, CharSequence content) {
        showOsd(title, left, right, icon, content, 0, 0, 0);
    }

    public static void showOsd(CharSequence title, Icon left, Icon right, Icon icon, CharSequence content, int progress, int progressMin, int progressMax) {
        showOsd(title, left, right, icon, content, progress, progressMin, progressMax, -1);
    }

    public static void showOsd(CharSequence title, Icon left, Icon right, Icon icon, CharSequence content, int progress, int progressMin, int progressMax, int sharedId) {
