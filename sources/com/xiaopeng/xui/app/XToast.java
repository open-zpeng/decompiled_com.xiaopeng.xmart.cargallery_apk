...
public class XToast {
    ...
    public static void showAt(int msgRes, int shareId) {
    ...
    public static void showShort(int msgRes, int shareId) {
    ...
    public static void showLong(int msgRes, int shareId) {
    ...
    public static void showLonger(int msgRes) {
        showLonger(Xui.getContext().getText(msgRes));
    }

    public static void showLonger(int msgRes, int shareId) {
    ...
    public static void show(CharSequence msg, int duration, int sharedId, int iconId) {
    ...
    private static Toast makeToast(int layoutId) {
