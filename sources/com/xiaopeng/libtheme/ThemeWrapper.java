    ...
    */
    private static int getThemeResourceId(int r3, android.content.Context r4, android.util.AttributeSet r5, int r6, int r7) {
        /*
            ...
            int[] r2 = new int[r2]
            r2[r0] = r3
            android.content.res.TypedArray r1 = r1.obtainStyledAttributes(r5, r2, r6, r7)
            goto L12
        L11:
            r1 = 0
        L12:
            if (r1 == 0) goto L31
            int r2 = r1.getResourceId(r0, r0)     // Catch: java.lang.Throwable -> L24 java.lang.Exception -> L2b
            if (r2 == 0) goto L21
        L1b:
            if (r1 == 0) goto L20
            r1.recycle()
    ...
    protected static void startImageDrawableTransition(final ImageView view, final Drawable startDrawable, final Drawable endDrawable) {
        Runnable runnable = new Runnable() { // from class: com.xiaopeng.libtheme.ThemeWrapper.5
            ...
            public void run() {
                Drawable drawable;
                try {
                    if (view != null && startDrawable != null && (drawable = endDrawable) != null) {
                        if (drawable.getLevel() != startDrawable.getLevel()) {
