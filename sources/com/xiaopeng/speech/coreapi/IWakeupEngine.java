        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 9:
                    ...
                    updateMinorWakeupWord(_arg02, _arg1, _arg2, _arg3);
                    reply.writeNoException();
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                    removeCommandWakeupWord(data.createStringArray());
                    reply.writeNoException();
                    return true;
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    updateShortcutWakeupWord(_arg05, _arg14, _arg24);
                    reply.writeNoException();
                    return true;
                case 16:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 17:
                    ...
                    addShortcutWakeupWord(_arg06, _arg15, _arg25);
                    reply.writeNoException();
                    return true;
                case 18:
                    data.enforceInterface(DESCRIPTOR);
                    removeShortcutWakeupWord(data.createStringArray());
                    reply.writeNoException();
                    return true;
                case 19:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 23:
                    ...
                    setDefaultWakeupEnabled(_arg0);
                    reply.writeNoException();
                    return true;
                case 24:
                    data.enforceInterface(DESCRIPTOR);
                    enableWakeupEnhance(data.readStrongBinder());
                    reply.writeNoException();
                    return true;
                case 25:
                    data.enforceInterface(DESCRIPTOR);
                    disableWakeupEnhance(data.readStrongBinder());
                    reply.writeNoException();
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 27:
                    ...
                    _arg0 = data.readInt() != 0;
                    setWheelWakeupEnabled(_arg07, _arg0);
                    reply.writeNoException();
                    return true;
                case 28:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 29:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt() != 0;
                    setDefaultOneshotEnabled(_arg0);
                    reply.writeNoException();
                    return true;
                case 30:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 33:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt() != 0;
                    setDefaultFastWakeEnabled(_arg0);
                    reply.writeNoException();
                    return true;
                case 34:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 37:
                    data.enforceInterface(DESCRIPTOR);
                    stopDialogReason(data.readString());
                    reply.writeNoException();
                    return true;
                case 38:
                    data.enforceInterface(DESCRIPTOR);
                    enableMainWakeupWord(data.readStrongBinder());
                    reply.writeNoException();
                    return true;
                case 39:
                    data.enforceInterface(DESCRIPTOR);
                    disableMainWakeupWord(data.readStrongBinder());
                    reply.writeNoException();
                    return true;
                case 40:
                    data.enforceInterface(DESCRIPTOR);
                    enableFastWakeEnhance(data.readStrongBinder());
                    reply.writeNoException();
                    return true;
                case 41:
                    data.enforceInterface(DESCRIPTOR);
                    disableFastWakeEnhance(data.readStrongBinder());
                    reply.writeNoException();
                    return true;
                case 42:
                    data.enforceInterface(DESCRIPTOR);
                    enableInterruptWake(data.readStrongBinder());
                    reply.writeNoException();
                    return true;
                case 43:
                    data.enforceInterface(DESCRIPTOR);
                    disableInterruptWake(data.readStrongBinder());
                    reply.writeNoException();
                    return true;
                case 44:
                    data.enforceInterface(DESCRIPTOR);
                    startDialogFrom(data.readString());
                    reply.writeNoException();
                    return true;
                case 45:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    disableWakeupWithInfo(_arg08, _arg16, _arg26, _arg34, _arg43);
                    reply.writeNoException();
                    return true;
                case 46:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    enableWakeupWithInfo(_arg09, _arg17, _arg27, _arg35);
                    reply.writeNoException();
                    return true;
                case 47:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    disableWheelWakeupWithInfo(_arg010, _arg18, _arg28, _arg36);
                    reply.writeNoException();
                    return true;
                case 48:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    enableWheelWakeupWithInfo(_arg011, _arg19, _arg29);
                    reply.writeNoException();
                    return true;
                case 49:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    suspendDialogWithReason(_arg012, _arg110, _arg210);
                    reply.writeNoException();
                    return true;
                case 50:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    resumeDialogWithReason(_arg013, _arg111, _arg211);
                    reply.writeNoException();
                    return true;
                case 1598968902:
