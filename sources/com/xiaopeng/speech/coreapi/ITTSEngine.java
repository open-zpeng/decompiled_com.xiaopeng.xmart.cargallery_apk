        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    boolean speak = speak(_arg02, _arg1, _arg2, _arg3);
                    reply.writeNoException();
                    reply.writeInt(speak ? 1 : 0);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    setSpeaker(data.readString());
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    shutup(data.readString());
                    reply.writeNoException();
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    addListener(ITTSCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    removeListener(ITTSCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 14:
                    ...
                    boolean speakEnhance = speakEnhance(_arg03, _arg13, _arg22, _arg32, _arg4, _arg5, _arg6);
                    reply.writeNoException();
