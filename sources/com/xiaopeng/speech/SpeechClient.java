...
public class SpeechClient implements ConnectManager.OnConnectCallback {
    ...
    public void init(Context context, ConnectManager.OnConnectCallback connectCallback) {
        LogUtils.i(this, "SpeechClient(%s) Start In %s, connectCallback: %s", "1.0", context.getPackageName(), connectCallback);
        HandlerThread workerThread = new HandlerThread("NodeWorker");
        workerThread.start();
        this.mWorkerHandler = new WorkerHandler(workerThread.getLooper());
    ...
    public void setAppName(String... names) {
