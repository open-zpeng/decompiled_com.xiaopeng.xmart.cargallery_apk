...
public class FeedListUIValue {
    ...
    public static FeedListUIValue fromJson(JSONObject jsonObject) {
        ...
        if (jsonObject != null) {
            ...
            if (jsonObject.has(BIConfig.PROPERTY.DATA_TYPE)) {
                value.type = jsonObject.optString(BIConfig.PROPERTY.DATA_TYPE);
            } else {
                value.type = null;
            }
        }
    ...
    public static String toJson(FeedListUIValue value) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(value.type)) {
                jsonObject.put(BIConfig.PROPERTY.DATA_TYPE, value.type);
            }
