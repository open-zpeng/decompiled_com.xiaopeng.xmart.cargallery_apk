...
public class WeatherBean extends BaseBean {
    ...
    public static WeatherBean fromJsonObj(JSONObject jsonObject) {
        ...
        String widgetName = jsonObject.optString(SerializableCookie.NAME);
    ...
    private static WeatherData parseWeathData(JSONObject beanObject) {
        ...
        tempBuilder.append(min).append("~").append(max).append(TEMP_SUPREFIX);
        weatherData.setTemperature(tempBuilder.toString());
