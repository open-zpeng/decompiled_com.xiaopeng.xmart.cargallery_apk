...
public class DialogNode_Processor implements ICommandProcessor {
    ...
    public String[] getSubscribeEvents() {
        return new String[]{DMStart.EVENT, DialogEvent.DIALOG_ERROR, DMEnd.EVENT, DMWait.EVENT, DialogEvent.DIALOG_CONTINUE, DialogEvent.WAKEUP_RESULT, DialogEvent.VAD_BEGIN, DialogEvent.VAD_END, DialogEvent.DIALOG_STATUS_CHANGED};
    }
}
