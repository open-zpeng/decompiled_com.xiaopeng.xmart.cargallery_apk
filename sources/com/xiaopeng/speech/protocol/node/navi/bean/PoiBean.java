...
public class PoiBean implements Parcelable {
    ...
    public static PoiBean fromJson(String fromJson) {
        ...
        try {
            ...
            if (json.has(SerializableCookie.NAME)) {
                poiBean.name = json.optString(SerializableCookie.NAME);
            }
            ...
            String str3 = str2;
            if (json.has(str3)) {
                poiBean.naviLat = json.optDouble(str3, 0.0d);
            }
            if (json.has(str)) {
                poiBean.typeCode = json.optString(str);
            }
            if (json.has("source")) {
    ...
    public JSONObject toJson() throws JSONException {
        ...
        json.put(SerializableCookie.NAME, getName());
