...
public class NewPhoneNode extends SpeechNode<PhoneListener> {
    ...
    public void incomingCallRing(String name, String number, boolean enableTts) {
        ...
        try {
            slots = new JSONObject().put("isLocalSkill", true).put("来电人", name).put("来电号码", number).put(WakeupResult.REASON_COMMAND, "command://phone.in.accept#command://phone.in.reject").put("enable_tts", enableTts).toString();
