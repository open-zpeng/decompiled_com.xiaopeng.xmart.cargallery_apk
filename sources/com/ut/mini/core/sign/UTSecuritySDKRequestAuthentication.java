...
public class UTSecuritySDKRequestAuthentication implements IUTRequestAuthentication {
    ...
    /* JADX WARN: Removed duplicated region for block: B:17:0x0051 A[Catch: all -> 0x00d7, TRY_ENTER, TRY_LEAVE, TryCatch #5 {, blocks: (B:3:0x0001, B:41:0x00e3, B:15:0x0046, B:17:0x0051, B:23:0x008e, B:36:0x00ba, B:18:0x0078, B:26:0x009e), top: B:51:0x0001 }] */
    /*
    ...
    */
    ...
    public String getSign(String toBeSignedStr) {
        ...
        if (this.g == null) {
            ...
            return null;
        } else if (toBeSignedStr == null || this.b == null || (cls = this.a) == null || this.f204a == null || this.f206b == null || this.f207c == null || this.f205a == null || this.c == null) {
            return null;
        } else {
            try {
