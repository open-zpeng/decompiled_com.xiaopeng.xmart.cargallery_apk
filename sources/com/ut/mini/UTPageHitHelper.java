...
public class UTPageHitHelper {
    ...
    private String m102a(Object obj) {
        String simpleName;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized boolean m105a(Object obj) {
        if (obj != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: a  reason: collision with other method in class */
    public synchronized void m104a(Object obj) {
        if (obj != null) {
            UTPageEventObject a2 = a(obj);
            if (a2.getPageStatus() != null) {
                a2.setH5Called();
    ...
    private synchronized UTPageEventObject a(Object obj) {
        String m102a = m102a(obj);
        if (this.A.containsKey(m102a)) {
            return this.A.get(m102a);
        }
        UTPageEventObject uTPageEventObject = new UTPageEventObject();
        this.A.put(m102a, uTPageEventObject);
        uTPageEventObject.setCacheKey(m102a);
    ...
    private synchronized void m103b(Object obj) {
        String m102a = m102a(obj);
        if (this.A.containsKey(m102a)) {
            this.A.remove(m102a);
        }
    ...
    public synchronized void a(Object obj, String str, boolean z) {
        if (obj != null) {
            String m102a = m102a(obj);
            if (m102a != null && m102a.equals(this.al)) {
                return;
            }
            if (this.al != null) {
